...
- **Préfinancement CESU** : avec `taxCredit.prefundedCesuAnnualEur` > 0 en emploi à domicile, une étape **`trace`** `scenario_tax_credit_prefunded_cesu` décrit l’effet sur l’assiette ; les plafonds employeur restent aussi dans `warnings` si besoin.
