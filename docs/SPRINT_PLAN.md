...
| Field | Value |
|--------|--------|
| **Product goal** | Reliable, transparent comparison of *real* childcare costs in France (2026), including social contributions, CAF/CMG, tax credits, employer schemes, and household fiscal effects. |
...
|----------|------------------|-----------------|
| _—_ | _—_ | _Example: GARDE-002 — 2026-03-21 — Done. Trace model landed as planned. Split `SourceRef` into its own module mid-story; GARDE-003 schema will import it._ |
...
| **Harness** | Instructions, tool wiring, optional wrappers so an agent *uses* the core inside Claude / ChatGPT / Gemini | **Per-vendor** artifacts + docs |
