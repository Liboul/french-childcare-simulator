...
| **GARDE-034** | 2026-03-21       | Done. **DR-06** : `domicileComplementaryCosts` (nounou domicile / partagée), lignes brut, assiette CI `monthlyBrutTaxCreditAssietteEur`, warnings, exports, démo + harness. Exclusion plafond CMG LFSS 2026 non codée (voir DR-06). Spec : `docs/stories/GARDE-034.md`. |
...
**Non traité dans ce lot :** **GARDE-019** (IR / TMI — `[DEEP RESEARCH]`).
