...
export function buildCrechePubliqueLignes(
  ...
  lignes.push({
    libelle: "Dépenses éligibles au crédit d’impôt (année, plafond par enfant)",
    montantEur: 0,
    calcul: `Éligible annuelle = ${String(t.annualEligibleExpenseForCreditEur)} € (${String(t.childrenCount)} enfant(s), garde ${t.custody === "full" ? "classique" : "alternée"})`,
